...
class RandomModell extends PunktDistribusjon {
    ...
    protected final int avstand, ant;
    ...
    public int estimertAvstand() {
        return (int) (1 / (Math.sqrt(ant / ((double) (bredde * høyde)))));
    }
}

class HexModell extends GridModell {

    public HexModell(int caAntall, int bredde, int høyde, int avstand) {
        super(caAntall, bredde, høyde, avstand);
    }
...
class GridModell extends PunktDistribusjon {
    ...
    public GridModell(int caAntall, int bredde, int høyde, int avstand) {
        super(høyde, bredde);
        ...
        delta = Math.min((bredde - avstand) / kol, (høyde - avstand) / rad);
        this.avstand = avstand;
    }
...
class SpiralModell extends RandomModell {
    ...
    public SpiralModell(int antall, int bredde, int høyde, int avstand, double vinkelRadian) {
